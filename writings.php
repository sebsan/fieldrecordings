...
<div id="writing_outer">
	<div id="colonne-writings_1">
		...
		<p class="writings_1">
		<a name= "1">1. Exchanging artistic projects and ideas.</a></p>
		...
		<p class="writings_1">
		<a name="2">2. Exchanging sounds across borders.<a></p>
		<p>On the other hand the project aims to stimulate a collaborative creation and exploration of the European soundscape, which can contribute to an enhancement of peopleʼs imagination and sensitivity to sounds, and an openness to their and othersʼ environments and cultures.</p>

		<div class="picture"><img src="img/BeritGreinke_SHHH_11.jpg" width="80%"></div>
	
			<p class="writings_2">
			<a name="2.1">2.1. Exploration.</a></p>
			<p>From learning to listen, to traveling through Europe “Music is an aesthetic perception/understanding/conception of sound. Attaining this musical state requires a profound listening, an immersion in the inside of sound matter.” (Francisco Lopez, sound artist, Spain) “With the work of field recording always comes a travel, a shift or movement that also shifts the conditions of perception.”(Pali Meursault, field recordist, France)
...
<div id="colonne-writings_2">
	<div class="writings_sommaire">
		<p><a href="#1">1. Exchanging artistic projects and ideas.</p>
		<p><a href="#2">2. Exchanging sounds across borders.<a></p>
			<p><a href="#2.1">2.1. Exploration.<a></p>
			<p><a href="#2.2">2.2. Creation and exchange of sounds.<a></p>
		</div>
